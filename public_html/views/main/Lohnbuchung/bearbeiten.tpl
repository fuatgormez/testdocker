...
{{$title="Lohnbuchung | bearbeiten" scope=parent}}
...
<div class="row mb-4">
    <div class="col">
        <div class="content-box">
            ...
            <form action="/lohnbuchung/bearbeiten/{{$smarty_vars.values.id|default:"???"}}" method="post">
                <div class="row">
                    <div class="form-group col-12 col-sm-6">
                        <label class="form-control-label" for="jahr">Jahr <span class="required">*</span></label>
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-calendar fa-fw"></i></span>
                            <input name="jahr" type="text" class="form-control" id="jahr" value="{{$smarty_vars.values.jahr|default:""}}" placeholder="JJJJ">
                        </div>
                    </div>
                    <div class="form-group col-12 col-sm-6">
