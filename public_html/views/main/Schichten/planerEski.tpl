...
<div class="row mb-4 print-hide" style="font-size: 10px;">
    ...
    {{foreach from=$smarty_vars.data item='kunde'}}
        ...
        {{if $smarty_vars.company != 'tps'}}
            <div class="print-show mb-4">
                Bezugnehmend auf den Arbeitnehmerüberlassungsvertrag vom {{$kunde.unterzeichnungsdatumrahmenvertrag}} besetzen wir Ihre Schichten mit den aufgeführten Mitarbeitern:
            </div>
        {{/if}}
                        ...
                        <div class="col-12 col-xl">
                                <div class="row mx-0" >
                                        <div class="col-3 col-sm-6 col-md-4 col-lg-3 col-xl px-1px overflow-x-auto">
                                            ...
                                            Berliner Str. 55, D-10713 Berlin<br>
