...
class AbteilungModel extends Model
{
    ...
    public function getPalettenabteilung()
    {
        return $this->palettenabteilung == 1;
    }
    ...
    public function setPalettenabteilung(string $value)
    {
        return $this->setAttribute('palettenabteilung', $value);
    }
}
