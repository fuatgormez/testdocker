...
class KundenkonditionModel extends Model
{
    ...
    public function getZeitProPalette()
    {
        return new \DateTime("0000-00-00 " . $this->zeit_pro_palette);
    }
    ...
    public function setZeitProPalette(string $value)
    {
        return $this->setAttribute('zeit_pro_palette', $value);
    }
}
