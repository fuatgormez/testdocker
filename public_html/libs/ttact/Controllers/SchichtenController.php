...
class SchichtenController extends Controller
{
    ...
    public function planer()
    {
        ...
        if ($redirect) {
            ...
            function storeAbteilungsdaten(&$data, $company, $kunde, $abteilung,$ddm) {
                if (!isset($data[$kunde->getKundennummer()]['abteilungen'][$abteilung->getID()]['id'])) {
                    ...
                    if ($company == 'aps') {
                        $mm = \ttact\Models\KundenkonditionModel::getKundeAbteulengPries($ddm,$kunde->getID(), $abteilung->getID());                        
                        $data[$kunde->getKundennummer()]['abteilungen'][$abteilung->getID()]['preis'] = $mm->getPreis()."€";
                    }
                }
            }
            foreach ($auftraege as $auftrag) {
                ...
                storeAbteilungsdaten($data, $this->company, $auftrag->getKunde(), $auftrag->getAbteilung(),$this->db);
            }
            ...
            if ($this->company == 'tps') {
                ...
                foreach ($paletten as $palette) {
                    ...
                    storeAbteilungsdaten($data, $this->company, $palette->getKunde(), $palette->getAbteilung(),$this->db);
                }
            }
