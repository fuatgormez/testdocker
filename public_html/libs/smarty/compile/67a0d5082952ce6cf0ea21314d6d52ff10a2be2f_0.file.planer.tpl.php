<?php
/* Smarty version 3.1.30, created on 2021-04-28 14:03:38
  from "/usr/local/www/apache24/noexec/ttact-intern-software/views/main/Schichten/planer.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_60894f1a509bb6_96610845',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '67a0d5082952ce6cf0ea21314d6d52ff10a2be2f' => 
    array (
      0 => '/usr/local/www/apache24/noexec/ttact-intern-software/views/main/Schichten/planer.tpl',
      1 => 1619611411,
      2 => 'file',
    ),
  ),
...
function content_60894f1a509bb6_96610845 (Smarty_Internal_Template $_smarty_tpl) {
...
$_smarty_tpl->_assignInScope('title', "Schichtplaner" ,false ,2);
?>

<?php if (isset($_smarty_tpl->tpl_vars['smarty_vars']->value['values']['title_zusatz'])) {?>
    <?php $_smarty_tpl->_assignInScope('title_zusatz', $_smarty_tpl->tpl_vars['smarty_vars']->value['values']['title_zusatz'] ,true ,2);
}?>

<?php $_smarty_tpl->_assignInScope('hide_title', true ,false ,2);
?>
    ...
    <div class="col" id="header-col">
        <div class="content-box p-0" id="header">
            ...
            <div class="title-box text-white px-4 py-3" id="header-non-sticky">
                <h4 class="mb-0 hidden-xs-down">Schichtplaner<span class="float-right"><a class="change-kw-button" href="/schichten/planer/<?php echo (($tmp = @$_smarty_tpl->tpl_vars['smarty_vars']->value['letzte_woche']['jahr'])===null||$tmp==='' ? "???" : $tmp);?>
/<?php echo (($tmp = @$_smarty_tpl->tpl_vars['smarty_vars']->value['letzte_woche']['kw'])===null||$tmp==='' ? "???" : $tmp);?>
/<?php echo (($tmp = @$_smarty_tpl->tpl_vars['smarty_vars']->value['kunden_url_string'])===null||$tmp==='' ? '' : $tmp);?>
"><i class="fa fa-chevron-circle-left mr-3"></i></a><span class="hidden-xs-down">KW <?php echo (($tmp = @smarty_modifier_date_format($_smarty_tpl->tpl_vars['smarty_vars']->value['von'],"W"))===null||$tmp==='' ? "???" : $tmp);?>
</span><span class="hidden-sm-down"> | <?php echo (($tmp = @smarty_modifier_date_format($_smarty_tpl->tpl_vars['smarty_vars']->value['von'],"d.m."))===null||$tmp==='' ? "???" : $tmp);?>
 - <?php echo (($tmp = @smarty_modifier_date_format($_smarty_tpl->tpl_vars['smarty_vars']->value['bis'],"d.m.Y"))===null||$tmp==='' ? "???" : $tmp);?>
</span><a class="change-kw-button" href="/schichten/planer/<?php echo (($tmp = @$_smarty_tpl->tpl_vars['smarty_vars']->value['naechste_woche']['jahr'])===null||$tmp==='' ? "???" : $tmp);?>
/<?php echo (($tmp = @$_smarty_tpl->tpl_vars['smarty_vars']->value['naechste_woche']['kw'])===null||$tmp==='' ? "???" : $tmp);?>
/<?php echo (($tmp = @$_smarty_tpl->tpl_vars['smarty_vars']->value['kunden_url_string'])===null||$tmp==='' ? '' : $tmp);?>
"><i class="fa fa-chevron-circle-right ml-3 mr-2"></i></a><span class="hidden-md-down"> | <?php echo (($tmp = @$_smarty_tpl->tpl_vars['smarty_vars']->value['kunden'])===null||$tmp==='' ? "???" : $tmp);?>
</span><span class="fa fa-bars ml-4 header-button"></span></span></h4>
            ...
            <div class="title-box text-white p-2 px-sm-4 py-sm-3" id="header-sticky" style="display:none;">
                ...
                <h5 class="mb-0 hidden-xs-down">KW <?php echo (($tmp = @smarty_modifier_date_format($_smarty_tpl->tpl_vars['smarty_vars']->value['von'],"W"))===null||$tmp==='' ? "???" : $tmp);?>
 | <?php echo (($tmp = @smarty_modifier_date_format($_smarty_tpl->tpl_vars['smarty_vars']->value['von'],"d.m."))===null||$tmp==='' ? "???" : $tmp);?>
 - <?php echo (($tmp = @smarty_modifier_date_format($_smarty_tpl->tpl_vars['smarty_vars']->value['bis'],"d.m.Y"))===null||$tmp==='' ? "???" : $tmp);?>
<span class="float-right" id="abteilung-gross">&nbsp;</span></h5>
                                ...
                                <div class="input-group">
                                    <div class="input-group-btn">
                                        <button type="button" class="btn btn-secondary dropdown-toggle p-xs-down-1" data-toggle="dropdown">
                                            <span class="hidden-md-down" id="jahresauswahl_button"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['smarty_vars']->value['values']['jahr'])===null||$tmp==='' ? "???" : $tmp);?>
</span>
                                        </button>
...
"<?php if ($_smarty_tpl->tpl_vars['row']->value['selected']) {?> selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['row']->value['kundennummer'];?>
                    ...
                    <div class="col-12 col-lg-4">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="progress mt-3 mb-2">
                                <div class="progress-bar" id="progress_bar" style="width: <?php echo (($tmp = @$_smarty_tpl->tpl_vars['smarty_vars']->value['statistiken']['prozent'])===null||$tmp==='' ? "0" : $tmp);?>
%; height: 20px; line-height: 20px; overflow: hidden;"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['smarty_vars']->value['statistiken']['prozent'])===null||$tmp==='' ? "0" : $tmp);?>
%</div>
                            </div>
                            <div class="mb-3"><span id="statistik_offen"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['smarty_vars']->value['statistiken']['offen'])===null||$tmp==='' ? "???" : $tmp);?>
</span> offene<span id="statistik_insgesamt" class="float-right"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['smarty_vars']->value['statistiken']['insgesamt'])===null||$tmp==='' ? "???" : $tmp);?>
 insgesamt</span></div>
                            <div>noch nicht benachrichtigt:<span id="statistik_nicht_benachrichtigt" class="float-right"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['smarty_vars']->value['statistiken']['nicht_benachrichtigt'])===null||$tmp==='' ? "???" : $tmp);?>
</span></div>
                            <div>benachrichtigt:<span id="statistik_benachrichtigt" class="float-right"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['smarty_vars']->value['statistiken']['benachrichtigt'])===null||$tmp==='' ? "???" : $tmp);?>
</span></div>
                            <div>umgeplant / noch zu bestätigen:<span id="statistik_nicht_bestaetigt" class="float-right"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['smarty_vars']->value['statistiken']['nicht_bestaetigt'])===null||$tmp==='' ? "???" : $tmp);?>
</span></div>
                            <div>MA abgesagt / Tag geht nicht:<span id="statistik_kann_nicht" class="float-right"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['smarty_vars']->value['statistiken']['kann_nicht'])===null||$tmp==='' ? "???" : $tmp);?>
</span></div>
                            <div>MA abgesagt / Zeit geht nicht:<span id="statistik_kann_andere_uhrzeit" class="float-right"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['smarty_vars']->value['statistiken']['kann_andere_uhrzeit'])===null||$tmp==='' ? "???" : $tmp);?>
</span></div>
                            <div>mit Stundenzettel abgeglichen:<span id="statistik_stundenzettel_bestaetigt" class="float-right"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['smarty_vars']->value['statistiken']['stundenzettel_bestaetigt'])===null||$tmp==='' ? "???" : $tmp);?>
</span></div>
                            <div>abgeschlossen:<span id="statistik_archiviert" class="float-right"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['smarty_vars']->value['statistiken']['archiviert'])===null||$tmp==='' ? "???" : $tmp);?>
</span></div>
                        </div>
                        <div>
                            <?php if ($_smarty_tpl->tpl_vars['smarty_vars']->value['aenderungen']) {?>
                                ...
                                <button id="monat_abschliessen" class="btn btn-secondary btn-block"><?php echo $_smarty_tpl->tpl_vars['smarty_vars']->value['monat'][smarty_modifier_date_format($_smarty_tpl->tpl_vars['smarty_vars']->value['von'],"m")];?>
 abschließen</button>
                                <?php if ($_smarty_tpl->tpl_vars['smarty_vars']->value['woche_oeffnen_dispotabelle_herunterladen']) {?>
                                    ...
                                    <a class="btn btn-secondary btn-block" target="_blank" href="/schichten/dispotabelle/<?php echo (($tmp = @$_smarty_tpl->tpl_vars['smarty_vars']->value['requested_year'])===null||$tmp==='' ? "???" : $tmp);?>
/<?php echo (($tmp = @$_smarty_tpl->tpl_vars['smarty_vars']->value['requested_week'])===null||$tmp==='' ? "???" : $tmp);?>
">Dispotabelle herunterladen</a>
                                <?php }?>
                            <?php }?>
                        </div>
                    </div>
...
<div class="row mb-4 print-show">
    <div class="col">
        <div class="content-box p-4 header-print">
            <h3>KW <?php echo (($tmp = @$_smarty_tpl->tpl_vars['smarty_vars']->value['requested_week'])===null||$tmp==='' ? "???" : $tmp);?>
 | <?php echo (($tmp = @smarty_modifier_date_format($_smarty_tpl->tpl_vars['smarty_vars']->value['von'],"d.m."))===null||$tmp==='' ? "???" : $tmp);?>
 - <?php echo (($tmp = @smarty_modifier_date_format($_smarty_tpl->tpl_vars['smarty_vars']->value['bis'],"d.m.Y"))===null||$tmp==='' ? "???" : $tmp);?>
</h3>
        </div>
...
<?php if (isset($_smarty_tpl->tpl_vars['smarty_vars']->value['data'])) {?>
    <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['smarty_vars']->value['data'], 'kunde');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['kunde']->value) {
?>
        <div class="row mb-4">
            <div class="col">
                <div class="content-box p-0">
                    <div class="kunde-title px-4 py-3" data-kunde="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['kunde']->value['kundennummer'])===null||$tmp==='' ? "???" : $tmp);?>
 - <?php echo (($tmp = @$_smarty_tpl->tpl_vars['kunde']->value['name'])===null||$tmp==='' ? "???" : $tmp);?>
">
                        <div class="kunde-title-bezeichnung float-left">
                            <h4 class="mb-0 hidden-xs-down">Kunde <?php echo (($tmp = @$_smarty_tpl->tpl_vars['kunde']->value['kundennummer'])===null||$tmp==='' ? "???" : $tmp);?>
 | <?php echo (($tmp = @$_smarty_tpl->tpl_vars['kunde']->value['name'])===null||$tmp==='' ? "???" : $tmp);?>
</h4>
                            <h5 class="mb-0 hidden-sm-up">Kunde <?php echo (($tmp = @$_smarty_tpl->tpl_vars['kunde']->value['kundennummer'])===null||$tmp==='' ? "???" : $tmp);?>
 | <?php echo (($tmp = @$_smarty_tpl->tpl_vars['kunde']->value['name'])===null||$tmp==='' ? "???" : $tmp);?>
</h5>
                        </div>
                        <div class="kunde-title-info-symbol print-hide">
                            <h4 class="mb-0 text-right hidden-xs-down"><span class="fa fa-info-circle kunde-button print-hidden" data-kunde-id="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['kunde']->value['id'])===null||$tmp==='' ? "???" : $tmp);?>
"></span></h4>
                            <h5 class="mb-0 text-right hidden-sm-up"><span class="fa fa-info-circle kunde-button print-hidden" data-kunde-id="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['kunde']->value['id'])===null||$tmp==='' ? "???" : $tmp);?>
"></span></h5>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                        
                    <div class="p-4 kunde-menu" id="kunde-<?php echo (($tmp = @$_smarty_tpl->tpl_vars['kunde']->value['id'])===null||$tmp==='' ? "???" : $tmp);?>
-menu" style="display: none;">
                        <div class="row">
                            <div class="col-12 col-sm-6 col-md-4">
                                <div><strong>Kundennummer</strong></div>
                                <div class="mb-3"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['kunde']->value['kundennummer'])===null||$tmp==='' ? "???" : $tmp);?>
</div>

                                <div><strong>Name</strong></div>
                                <div class="mb-3"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['kunde']->value['name'])===null||$tmp==='' ? "???" : $tmp);?>
</div>

                                <div><strong>Strasse, Hausnr.</strong></div>
                                <div class="mb-3"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['kunde']->value['strasse'])===null||$tmp==='' ? "- nicht vorhanden -" : $tmp);?>
</div>

                                <div><strong>Postleitzahl</strong></div>
                                <div class="mb-3"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['kunde']->value['postleitzahl'])===null||$tmp==='' ? "- nicht vorhanden -" : $tmp);?>
</div>

                                <div><strong>Ort</strong></div>
                                <div class="mb-3 mb-md-0"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['kunde']->value['ort'])===null||$tmp==='' ? "- nicht vorhanden -" : $tmp);?>
</div>
                            </div>
                            <div class="col-12 col-sm-6 col-md-4">
                                <div><strong>Ansprechpartner</strong></div>
                                <div class="mb-3"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['kunde']->value['ansprechpartner'])===null||$tmp==='' ? "- nicht vorhanden -" : $tmp);?>
</div>

                                <div><strong>Telefon 1</strong></div>
                                <div class="mb-3"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['kunde']->value['telefon1'])===null||$tmp==='' ? "- nicht vorhanden -" : $tmp);?>
</div>

                                <div><strong>Telefon 2</strong></div>
                                <div class="mb-3"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['kunde']->value['telefon2'])===null||$tmp==='' ? "- nicht vorhanden -" : $tmp);?>
</div>

                                <div><strong>Fax</strong></div>
                                <div class="mb-3"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['kunde']->value['fax'])===null||$tmp==='' ? "- nicht vorhanden -" : $tmp);?>
</div>

                                <div><strong>E-Mail-Adresse</strong></div>
                                <div class="mb-3 mb-md-0"><a href="mailto:<?php echo (($tmp = @$_smarty_tpl->tpl_vars['kunde']->value['emailadresse'])===null||$tmp==='' ? '' : $tmp);?>
"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['kunde']->value['emailadresse'])===null||$tmp==='' ? "- nicht vorhanden -" : $tmp);?>
</a></div>
                            </div>
                            <div class="col-12 col-md-4">
                                <?php if ($_smarty_tpl->tpl_vars['smarty_vars']->value['aenderungen']) {?>
                                    <div><button class="btn btn-secondary btn-block kunde_abschliessen mb-3" data-kunde-id="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['kunde']->value['id'])===null||$tmp==='' ? "???" : $tmp);?>
">Kunden abschließen</button></div>
                                    <div><button class="btn btn-secondary btn-block monat_abschliessen mb-3" data-kunde-id="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['kunde']->value['id'])===null||$tmp==='' ? "???" : $tmp);?>
"><?php echo $_smarty_tpl->tpl_vars['smarty_vars']->value['monat'][smarty_modifier_date_format($_smarty_tpl->tpl_vars['smarty_vars']->value['von'],"m")];?>
 abschließen</button></div>
                                    <?php if ($_smarty_tpl->tpl_vars['smarty_vars']->value['woche_oeffnen_dispotabelle_herunterladen']) {?>
                                        <div><button class="btn btn-secondary btn-block kunde_oeffnen" data-kunde-id="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['kunde']->value['id'])===null||$tmp==='' ? "???" : $tmp);?>
">Kunden öffnen</button></div>
                                    <?php }?>
                                <?php }?>
                            </div>
                        </div>
        ...
        <?php if ($_smarty_tpl->tpl_vars['smarty_vars']->value['company'] != 'tps') {?>
            <div class="print-show mb-4">
                Bezugnehmend auf den Arbeitnehmerüberlassungsvertrag vom <?php echo $_smarty_tpl->tpl_vars['kunde']->value['unterzeichnungsdatumrahmenvertrag'];?>
 besetzen wir Ihre Schichten mit den aufgeführten Mitarbeitern: | Betriebsnummer: 26073440
            </div>
        <?php }?>

        <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['kunde']->value['abteilungen'], 'abteilung');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['abteilung']->value) {
?>
            <div class="row mb-4 abteilung abteilung-<?php echo (($tmp = @$_smarty_tpl->tpl_vars['abteilung']->value['id'])===null||$tmp==='' ? "???" : $tmp);?>
">
                <?php if ($_smarty_tpl->tpl_vars['smarty_vars']->value['aenderungen']) {?>
                    <div class="hidden-lg-down col-xl-3 print-hide">
                        <div class="content-box schicht-menu-container-large" id="schicht-menu-container-large-<?php echo (($tmp = @$_smarty_tpl->tpl_vars['kunde']->value['id'])===null||$tmp==='' ? "???" : $tmp);?>
-<?php echo (($tmp = @$_smarty_tpl->tpl_vars['abteilung']->value['id'])===null||$tmp==='' ? "???" : $tmp);?>
">
                            <h4>Bearbeiten</h4>
                ...
                <div class="col-12 col-xl">
                    <div class="content-box abteilung-box" id="abteilung-box-<?php echo (($tmp = @$_smarty_tpl->tpl_vars['kunde']->value['id'])===null||$tmp==='' ? "???" : $tmp);?>
-<?php echo (($tmp = @$_smarty_tpl->tpl_vars['abteilung']->value['id'])===null||$tmp==='' ? "???" : $tmp);?>
" data-abteilung="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['abteilung']->value['name'])===null||$tmp==='' ? "???" : $tmp);?>
" data-kunde-id="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['kunde']->value['id'])===null||$tmp==='' ? "???" : $tmp);?>
" data-abteilung-id="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['abteilung']->value['id'])===null||$tmp==='' ? "???" : $tmp);?>
">
                        <h4><?php echo (($tmp = @$_smarty_tpl->tpl_vars['abteilung']->value['name'])===null||$tmp==='' ? "???" : $tmp);?>
  <span class="abteilung-preis"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['abteilung']->value['preis'])===null||$tmp==='' ? " " : $tmp);?>
 </span></h4>
                        <div class="row mx-0">
                            <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['abteilung']->value['schichten'], 'schichten', false, 'wochentag');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['wochentag']->value => $_smarty_tpl->tpl_vars['schichten']->value) {
?>
                                <!-- Wochentagsspalte -->
                                <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl px-1px overflow-x-auto" id="wochentagsspalte-<?php echo (($tmp = @$_smarty_tpl->tpl_vars['kunde']->value['id'])===null||$tmp==='' ? "???" : $tmp);?>
-<?php echo (($tmp = @$_smarty_tpl->tpl_vars['abteilung']->value['id'])===null||$tmp==='' ? "???" : $tmp);?>
-<?php echo (($tmp = @$_smarty_tpl->tpl_vars['wochentag']->value)===null||$tmp==='' ? "???" : $tmp);?>
">
                                    <!-- Wochentagsbezeichnung -->
                                    <div class="wochentag">
                                        <div class="float-left wochentag-name">
                                            <?php echo (($tmp = @$_smarty_tpl->tpl_vars['smarty_vars']->value['wochentage'][$_smarty_tpl->tpl_vars['wochentag']->value]['name'])===null||$tmp==='' ? "???" : $tmp);?>

                                        </div>
                                        <div class="text-right wochentag-pluszeichen-container">
                                            <?php if ($_smarty_tpl->tpl_vars['smarty_vars']->value['aenderungen']) {?>
                                                <i class="fa fa-plus-circle wochentag-pluszeichen print-hide" data-year="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['smarty_vars']->value['requested_year'])===null||$tmp==='' ? "???" : $tmp);?>
" data-kw="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['smarty_vars']->value['requested_week'])===null||$tmp==='' ? "???" : $tmp);?>
" data-day="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['wochentag']->value)===null||$tmp==='' ? "???" : $tmp);?>
" data-kunde-id="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['kunde']->value['id'])===null||$tmp==='' ? "???" : $tmp);?>
" data-abteilung-id="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['abteilung']->value['id'])===null||$tmp==='' ? "???" : $tmp);?>
"></i>
                                            <?php }?>
                                        ...
                                        <div>
                                            <?php echo (($tmp = @$_smarty_tpl->tpl_vars['smarty_vars']->value['wochentage'][$_smarty_tpl->tpl_vars['wochentag']->value]['datum'])===null||$tmp==='' ? "???" : $tmp);?>
                                    ...
                                    <?php if ($_smarty_tpl->tpl_vars['smarty_vars']->value['company'] == 'tps') {?>
                                        <?php if ($_smarty_tpl->tpl_vars['abteilung']->value['palettenabteilung']) {?>
                                        <!-- Palettenanzahl -->
                                            <div class="palettenanzahl has-tooltip p-0" id="palettenanzahl-<?php echo (($tmp = @$_smarty_tpl->tpl_vars['kunde']->value['id'])===null||$tmp==='' ? "???" : $tmp);?>
-<?php echo (($tmp = @$_smarty_tpl->tpl_vars['abteilung']->value['id'])===null||$tmp==='' ? "???" : $tmp);?>
-<?php echo (($tmp = @$_smarty_tpl->tpl_vars['wochentag']->value)===null||$tmp==='' ? "???" : $tmp);?>
" data-toggle="tooltip" data-placement="top" title="Palettenanzahl">
                                                <div class="form-group m-0">
                                                    <input type="text" class="form-control palettenanzahl-input" id="palettenanzahl-input-<?php echo (($tmp = @$_smarty_tpl->tpl_vars['kunde']->value['id'])===null||$tmp==='' ? "???" : $tmp);?>
-<?php echo (($tmp = @$_smarty_tpl->tpl_vars['abteilung']->value['id'])===null||$tmp==='' ? "???" : $tmp);?>
-<?php echo (($tmp = @$_smarty_tpl->tpl_vars['wochentag']->value)===null||$tmp==='' ? "???" : $tmp);?>
" value="<?php echo number_format((($tmp = @$_smarty_tpl->tpl_vars['abteilung']->value['paletten'][$_smarty_tpl->tpl_vars['wochentag']->value])===null||$tmp==='' ? 0 : $tmp),2,",",".");?>
" data-original-value="<?php echo number_format((($tmp = @$_smarty_tpl->tpl_vars['abteilung']->value['paletten'][$_smarty_tpl->tpl_vars['wochentag']->value])===null||$tmp==='' ? 0 : $tmp),2,",",".");?>
" data-year="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['smarty_vars']->value['requested_year'])===null||$tmp==='' ? "???" : $tmp);?>
" data-kw="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['smarty_vars']->value['requested_week'])===null||$tmp==='' ? "???" : $tmp);?>
" data-day="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['wochentag']->value)===null||$tmp==='' ? "???" : $tmp);?>
" data-kunde-id="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['kunde']->value['id'])===null||$tmp==='' ? "???" : $tmp);?>
" data-abteilung-id="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['abteilung']->value['id'])===null||$tmp==='' ? "???" : $tmp);?>
">
                                    ...
                                    <!-- Schichtstunden -->
                                    <div class="schichtstunden has-tooltip" data-toggle="tooltip" data-placement="top" title="Schichtstunden" id="schichtstunden-<?php echo (($tmp = @$_smarty_tpl->tpl_vars['kunde']->value['id'])===null||$tmp==='' ? "???" : $tmp);?>
-<?php echo (($tmp = @$_smarty_tpl->tpl_vars['abteilung']->value['id'])===null||$tmp==='' ? "???" : $tmp);?>
-<?php echo (($tmp = @$_smarty_tpl->tpl_vars['wochentag']->value)===null||$tmp==='' ? "???" : $tmp);?>
">
                                        <?php echo number_format((($tmp = @$_smarty_tpl->tpl_vars['abteilung']->value['stunden'][$_smarty_tpl->tpl_vars['wochentag']->value])===null||$tmp==='' ? "0" : $tmp),2,",",".");
if ($_smarty_tpl->tpl_vars['smarty_vars']->value['company'] != 'tps') {
if ($_smarty_tpl->tpl_vars['wochentag']->value == 7) {?> / <span class="font-weight-bold" id="schichtstunden-insgesamt-<?php echo (($tmp = @$_smarty_tpl->tpl_vars['kunde']->value['id'])===null||$tmp==='' ? "???" : $tmp);?>
-<?php echo (($tmp = @$_smarty_tpl->tpl_vars['abteilung']->value['id'])===null||$tmp==='' ? "???" : $tmp);?>
"><?php echo number_format((($tmp = @$_smarty_tpl->tpl_vars['abteilung']->value['stunden']['insgesamt'])===null||$tmp==='' ? "0" : $tmp),2,",",".");?>
</span><?php }
}?>
                                    </div>
                                    <!-- /Schichtstunden -->
                                    ...
                                    <?php if ($_smarty_tpl->tpl_vars['smarty_vars']->value['company'] == 'tps') {?>
                                        <?php if ($_smarty_tpl->tpl_vars['abteilung']->value['palettenabteilung']) {?>
                                            ...
                                            <div class="produktivitaetsfaktor has-tooltip" data-toggle="tooltip" data-placement="top" title="Produktivitätsfaktor" id="produktivitaetsfaktor-<?php echo (($tmp = @$_smarty_tpl->tpl_vars['kunde']->value['id'])===null||$tmp==='' ? "???" : $tmp);?>
-<?php echo (($tmp = @$_smarty_tpl->tpl_vars['abteilung']->value['id'])===null||$tmp==='' ? "???" : $tmp);?>
-<?php echo (($tmp = @$_smarty_tpl->tpl_vars['wochentag']->value)===null||$tmp==='' ? "???" : $tmp);?>
">
                                                <?php echo number_format((($tmp = @$_smarty_tpl->tpl_vars['abteilung']->value['produktivitaetsfaktor'][$_smarty_tpl->tpl_vars['wochentag']->value])===null||$tmp==='' ? 0 : $tmp),2,",",".");?>
                                    ...
                                    <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['schichten']->value, 'schicht');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['schicht']->value) {
?>
                                        <!-- Schichten -->
                                        <div class="schicht <?php echo (($tmp = @$_smarty_tpl->tpl_vars['schicht']->value['status'])===null||$tmp==='' ? "???" : $tmp);?>
" id="schicht-<?php echo (($tmp = @$_smarty_tpl->tpl_vars['schicht']->value['id'])===null||$tmp==='' ? "???" : $tmp);?>
" data-id="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['schicht']->value['id'])===null||$tmp==='' ? "???" : $tmp);?>
" data-status="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['schicht']->value['status'])===null||$tmp==='' ? "???" : $tmp);?>
" data-mitarbeiter-id="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['schicht']->value['mitarbeiter_id'])===null||$tmp==='' ? '' : $tmp);?>
">
                                            <div class="text-center<?php if (($_smarty_tpl->tpl_vars['schicht']->value['zusatzschicht'])) {?> bold<?php }?>"><span id="schicht-<?php echo (($tmp = @$_smarty_tpl->tpl_vars['schicht']->value['id'])===null||$tmp==='' ? "???" : $tmp);?>
-von"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['schicht']->value['von'])===null||$tmp==='' ? "???" : $tmp);?>
</span> - <span id="schicht-<?php echo (($tmp = @$_smarty_tpl->tpl_vars['schicht']->value['id'])===null||$tmp==='' ? "???" : $tmp);?>
-bis"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['schicht']->value['bis'])===null||$tmp==='' ? "???" : $tmp);?>
</span></div>

                                            <div class="float-left schicht-nachname" id="schicht-<?php echo (($tmp = @$_smarty_tpl->tpl_vars['schicht']->value['id'])===null||$tmp==='' ? "???" : $tmp);?>
-nachname"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['schicht']->value['nachname'])===null||$tmp==='' ? "???" : $tmp);?>
</div>
                                            <div class="text-right schicht-pause" id="schicht-<?php echo (($tmp = @$_smarty_tpl->tpl_vars['schicht']->value['id'])===null||$tmp==='' ? "???" : $tmp);?>
-pause"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['schicht']->value['pause'])===null||$tmp==='' ? "&nbsp;" : $tmp);?>
</div>

                                            <div class="float-left schicht-vorname" id="schicht-<?php echo (($tmp = @$_smarty_tpl->tpl_vars['schicht']->value['id'])===null||$tmp==='' ? "???" : $tmp);?>
-vorname"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['schicht']->value['vorname'])===null||$tmp==='' ? '' : $tmp);?>
</div>
                                            <div class="text-right schicht-personalnummer" id="schicht-<?php echo (($tmp = @$_smarty_tpl->tpl_vars['schicht']->value['id'])===null||$tmp==='' ? "???" : $tmp);?>
-personalnummer"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['schicht']->value['personalnummer'])===null||$tmp==='' ? "&nbsp;" : $tmp);?>
</div>
                                        </div>
                                        <!-- /Schichten -->
                                    <?php
...
?>
                            ...
                            <?php if ($_smarty_tpl->tpl_vars['smarty_vars']->value['company'] == 'tps') {?>
                                ...
                                <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl px-1px overflow-x-auto">
                                    ...
                                    <?php if ($_smarty_tpl->tpl_vars['abteilung']->value['palettenabteilung']) {?>
                                        <!-- Palettenanzahl -->
                                        <div class="palettenanzahl palettenanzahl-insgesamt text-white has-tooltip font-weight-bold" data-toggle="tooltip" data-placement="top" title="Palettenanzahl" id="palettenanzahl-insgesamt-<?php echo (($tmp = @$_smarty_tpl->tpl_vars['kunde']->value['id'])===null||$tmp==='' ? "???" : $tmp);?>
-<?php echo (($tmp = @$_smarty_tpl->tpl_vars['abteilung']->value['id'])===null||$tmp==='' ? "???" : $tmp);?>
">
                                            <?php echo number_format((($tmp = @$_smarty_tpl->tpl_vars['abteilung']->value['paletten']['insgesamt'])===null||$tmp==='' ? 0 : $tmp),2,",",".");?>
                                    ...
                                    <!-- Schichtstunden -->
                                    <div class="schichtstunden schichtstunden-insgesamt text-white has-tooltip font-weight-bold" data-toggle="tooltip" data-placement="top" title="Schichtstunden" id="schichtstunden-insgesamt-<?php echo (($tmp = @$_smarty_tpl->tpl_vars['kunde']->value['id'])===null||$tmp==='' ? "???" : $tmp);?>
-<?php echo (($tmp = @$_smarty_tpl->tpl_vars['abteilung']->value['id'])===null||$tmp==='' ? "???" : $tmp);?>
">
                                        <?php echo number_format((($tmp = @$_smarty_tpl->tpl_vars['abteilung']->value['stunden']['insgesamt'])===null||$tmp==='' ? "0" : $tmp),2,",",".");?>
                                    ...
                                    <?php if ($_smarty_tpl->tpl_vars['abteilung']->value['palettenabteilung']) {?>
                                        <!-- Produktivitätsfaktor -->
                                        <div class="produktivitaetsfaktor produktivitaetsfaktor-insgesamt text-white has-tooltip font-weight-bold" data-toggle="tooltip" data-placement="top" title="Produktivitätsfaktor" id="produktivitaetsfaktor-insgesamt-<?php echo (($tmp = @$_smarty_tpl->tpl_vars['kunde']->value['id'])===null||$tmp==='' ? "???" : $tmp);?>
-<?php echo (($tmp = @$_smarty_tpl->tpl_vars['abteilung']->value['id'])===null||$tmp==='' ? "???" : $tmp);?>
">
                                            <?php echo number_format((($tmp = @$_smarty_tpl->tpl_vars['abteilung']->value['produktivitaetsfaktor']['insgesamt'])===null||$tmp==='' ? 0 : $tmp),2,",",".");?>
...
?>
    ...
    <style>
        .schichtstunden<?php if ($_smarty_tpl->tpl_vars['smarty_vars']->value['company'] == 'tps') {?>, .palettenanzahl, .produktivitaetsfaktor<?php }?> {
            padding: 5px;
            background: #ddd;
            margin-bottom: 2px;
            text-align: right;
...
>
        $(document).ready(function () {
            ...
            $("#woche_abschliessen").click(function () {
                woche_abschliessen(<?php echo (($tmp = @$_smarty_tpl->tpl_vars['smarty_vars']->value['requested_year'])===null||$tmp==='' ? "'???'" : $tmp);?>
, <?php echo (($tmp = @$_smarty_tpl->tpl_vars['smarty_vars']->value['requested_week'])===null||$tmp==='' ? "'???'" : $tmp);?>
, function () {});
            });
            ...
            $("#monat_abschliessen").click(function () {
                monat_abschliessen(<?php echo (($tmp = @$_smarty_tpl->tpl_vars['smarty_vars']->value['requested_year'])===null||$tmp==='' ? "'???'" : $tmp);?>
, <?php echo (($tmp = @$_smarty_tpl->tpl_vars['smarty_vars']->value['requested_week'])===null||$tmp==='' ? "'???'" : $tmp);?>
, function () {});
            });
            ...
            $("#woche_oeffnen").click(function () {
                woche_oeffnen(<?php echo (($tmp = @$_smarty_tpl->tpl_vars['smarty_vars']->value['requested_year'])===null||$tmp==='' ? "'???'" : $tmp);?>
, <?php echo (($tmp = @$_smarty_tpl->tpl_vars['smarty_vars']->value['requested_week'])===null||$tmp==='' ? "'???'" : $tmp);?>
, function () {});
            });
            ...
            $(".kunde_abschliessen").click(function () {
                kunde_abschliessen(<?php echo (($tmp = @$_smarty_tpl->tpl_vars['smarty_vars']->value['requested_year'])===null||$tmp==='' ? "'???'" : $tmp);?>
, <?php echo (($tmp = @$_smarty_tpl->tpl_vars['smarty_vars']->value['requested_week'])===null||$tmp==='' ? "'???'" : $tmp);?>
, $(this).data("kundeId"), function () {});
            });

            // Kunde abschliessen
            $(".monat_abschliessen").click(function () {
                monat_abschliessen_kunde(<?php echo (($tmp = @$_smarty_tpl->tpl_vars['smarty_vars']->value['requested_year'])===null||$tmp==='' ? "'???'" : $tmp);?>
, <?php echo (($tmp = @$_smarty_tpl->tpl_vars['smarty_vars']->value['requested_week'])===null||$tmp==='' ? "'???'" : $tmp);?>
, $(this).data("kundeId"), function () {});
            });
            ...
            $(".kunde_oeffnen").click(function () {
                kunde_oeffnen(<?php echo (($tmp = @$_smarty_tpl->tpl_vars['smarty_vars']->value['requested_year'])===null||$tmp==='' ? "'???'" : $tmp);?>
, <?php echo (($tmp = @$_smarty_tpl->tpl_vars['smarty_vars']->value['requested_week'])===null||$tmp==='' ? "'???'" : $tmp);?>
, $(this).data("kundeId"), function () {});
            });
...
>
        ...
        $(document).ready(function () {
            ...
            $aktuelle_kw.click(function () {
                changeJahr(<?php echo (($tmp = @smarty_modifier_date_format(time(),"Y"))===null||$tmp==='' ? "-1" : $tmp);?>
, function() {
                    $kalenderwoche.val(<?php echo (($tmp = @smarty_modifier_date_format(time(),"W"))===null||$tmp==='' ? "-1" : $tmp);?>
).change();
                });
            });
            ...
            $vorige_kw.click(function () {
                changeJahr(<?php echo (($tmp = @$_smarty_tpl->tpl_vars['smarty_vars']->value['prev']['year'])===null||$tmp==='' ? "-1" : $tmp);?>
, function() {
                    $kalenderwoche.val(<?php echo (($tmp = @$_smarty_tpl->tpl_vars['smarty_vars']->value['prev']['week'])===null||$tmp==='' ? "-1" : $tmp);?>
).change();
                });
            });
            ...
            $naechste_kw.click(function () {
                changeJahr(<?php echo (($tmp = @$_smarty_tpl->tpl_vars['smarty_vars']->value['next']['year'])===null||$tmp==='' ? "-1" : $tmp);?>
, function() {
                    $kalenderwoche.val(<?php echo (($tmp = @$_smarty_tpl->tpl_vars['smarty_vars']->value['next']['week'])===null||$tmp==='' ? "-1" : $tmp);?>
).change();
                });
            });
        });
...
>
    ...
    <!-- Switchery -->
    <?php echo '<script'; ?>
 src="/assets/vendors/switchery/dist/switchery.min.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
>
        $(document).ready(function() {
...
>
    ...
    <!-- Sticky -->
    <?php echo '<script'; ?>
 src="/assets/vendors/garand-sticky-73b0fbe/jquery.sticky.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
>
        $(document).ready(function(){
...
>
    ...
    <!-- ScrollSpy -->
    <?php echo '<script'; ?>
 src="/assets/vendors/jquery-scrollspy-master/jquery-scrollspy.min.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
>
        $(document).ready(function () {
...
>
    ...
    <!-- Selectable -->
    <?php echo '<script'; ?>
 src="/assets/vendors/jquery-ui-1.12.1.custom/jquery-ui.min.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
>
...
>
        $(document).ready(function () {
            ...
            $last_update = '<?php echo (($tmp = @smarty_modifier_date_format(time(),"Y-m-d H:i:s"))===null||$tmp==='' ? "???" : $tmp);?>
';
            $year = '<?php echo (($tmp = @$_smarty_tpl->tpl_vars['smarty_vars']->value['requested_year'])===null||$tmp==='' ? "???" : $tmp);?>
';
            $week = '<?php echo (($tmp = @$_smarty_tpl->tpl_vars['smarty_vars']->value['requested_week'])===null||$tmp==='' ? "???" : $tmp);?>
';
            $kunden_json = '<?php echo (($tmp = @$_smarty_tpl->tpl_vars['smarty_vars']->value['kunden_json'])===null||$tmp==='' ? "???" : $tmp);?>
';
            update();
        });
                            ...
                            if (data.hasOwnProperty('schichten') && data.hasOwnProperty('last_update')) {
                                if (data.schichten.length > 0) {
                                    $.each(data.schichten, function (index, schicht) {
                                        <?php if ($_smarty_tpl->tpl_vars['smarty_vars']->value['company'] == 'tps') {?>if (schicht.action == 'update_palettenanzahl') {
                                        ...
                                        } else<?php }?> if (schicht.action == 'update_schichtstunden') {
